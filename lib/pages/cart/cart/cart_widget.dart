...
class CartWidget extends StatefulWidget {
  const CartWidget({
    Key? key,
    this.productDataCart,
  }) : super(key: key);

  final dynamic productDataCart;
                      ...
                      if (FFAppState().TokenLocal == null ||
                        ...
                        await showDialog(
                          ...
                          builder: (alertDialogContext) {
                            return AlertDialog(
                              title: Text('Token Got'),
                              content: Text(FFAppState().TokenLocal),
                              actions: [
                                TextButton(
                                  onPressed: () =>
